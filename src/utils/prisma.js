...
var PrismaService = /** @class */ (function () {
    ...
    PrismaService.getInstance = function () {
        if (!PrismaService.instance) {
            PrismaService.instance = new client_1.PrismaClient();
        }
        return PrismaService.instance;
    };
    PrismaService.disconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!PrismaService.instance) return [3 /*break*/, 2];
                        return [4 /*yield*/, PrismaService.instance.$disconnect()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
